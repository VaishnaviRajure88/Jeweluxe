                    ...
                    <div class="row margin-top">
                        <div class="col-md-3 col-sm-5 col-xs-6 social-icons">
                            <div>           
                                ...
                                <a href="https://www.instagram.com/vaishnavirajure/" target ="blank"><i class="fa fa-instagram"></i></a>
                        ...
                        <div class="col-md-7 col-md-offset-2 col-sm-7 col-xs-6">
                            <div class="nav pull-right" id="top-links">
                                <ul class="list-inline">
									<li><a><i class="fa fa-phone i_gray_color"></i> <span class="hidden-xs">+91-9284646579</span></a></li>
                                    <li><a href="register.php"><i class="fa fa-sign-in"></i> <span class="hidden-xs">Register</span></a></li>
                                    
						<?php session_start();
							if(isset($_SESSION["user"]))
							{
								if($_SESSION["user"]!="rajurevaishnavi@gmail.com")
								{
								include("connect.php");
